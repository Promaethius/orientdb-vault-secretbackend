...
func (c *orientdbConnectionProducer) Initialize(ctx context.Context, conf map[string]interface{}, verifyConnection bool) error {
	_, err := c.Init(ctx, conf, verifyConnection)
	return err
}

func (c *orientdbConnectionProducer) Init(ctx context.Context, conf map[string]interface{}, verifyConnection bool) (map[string]interface{}, error) {
	c.Lock()
	defer c.Unlock()
...
func (c *orientdbConnectionProducer) Connection(_ context.Context) (interface{}, error) {
	if !c.Initialized {
...
func (c *orientdbConnectionProducer) Close() error {
	// Grab the write lock
	c.Lock()
	defer c.Unlock()
...
func (c *orientdbConnectionProducer) createSession() (*gocql.Session, error) {
...
func (c *orientdbConnectionProducer) secretValues() map[string]interface{} {
